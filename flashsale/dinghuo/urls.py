...
urlpatterns = [
    ...
    url(r'^returngoods/replace_become_refund/$',
        staff_member_required(views.replace_become_refund),
        name="replace_become_refund"),
    url(r'^returngoods/create_pksi_by_RGDetail/$',
        staff_member_required(views.create_pksi_by_RGDetail),
        name="create_pksi_by_RGDetail"),
    url(r'^returngoods/pksi_is_pid/$',
        staff_member_required(views.pksi_is_pid),
        name="pksi_is_pid"),
