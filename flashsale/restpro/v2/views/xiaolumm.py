...
class RedirectStatsLinkView(APIView):
    ...
    links = [
        ...
        ['https://m.xiaolumeimei.com/rest/v1/users/weixin_login/?next=https://m.xiaolumeimei.com/mall/mama/boutique', MamaTabVisitStats.TAB_MAMA_BOUTIQUE],
        ['https://m.xiaolumeimei.com/rest/v1/users/weixin_login/?next=https://m.xiaolumeimei.com/mama_shop/html/personal.html', MamaTabVisitStats.TAB_UNKNOWN],
    ]
