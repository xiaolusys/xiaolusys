...
urlpatterns = [
    ...
    url(r'^assign/agent/$', views.WXPubAssignAgentView.as_view(), name="assign_agent"),
    url(r'^assign/agent/(?P<active_no>\d+)/$', views.WXPubAssignAgentView.as_view(), name="assign_agent_by_no"),
    # url(r'^assign/agent/$', RedirectView.as_view(url='/mall/'), name="assign_agent"),
    # url(r'^assign/agent/(?P<active_no>\d+)/$', RedirectView.as_view(url='/mall/'), name="assign_agent_by_no"),
]
