...
#         'ENGINE': 'django.db.backends.mysql',  # Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
#         'NAME': 'shopmgr',  # Or path to database file if using sqlite3.
#         'USER': 'devtest',  # Not used with sqlite3.
#         'PASSWORD': 'dev12345',  # Not used with sqlite3.
#         'HOST': 'youni.huyi.so',  # Set to empty string for localhost. Not used with sqlite3. #192.168.0.28
...
#         'HOST': 'staging.xiaolumm.com',  # Set to empty string for localhost. Not used with sqlite3. #192.168.0.28
#         'PORT': '30001',  # Set to empty string for default. Not used with sqlite3.
#         'OPTIONS':  {'init_command': 'SET storage_engine=Innodb;',
#                      'charset': 'utf8'},  # storage_engine need mysql>5.4,and table_type need mysql<5.4
#     }
