...
class MonthTradeReportStatusAdmin(admin.ModelAdmin):
    list_display = ('seller_id','year','month','update_order','update_purchase','update_amount','update_purchase_amount','update_logistics','update_refund','order_task_id','created')
