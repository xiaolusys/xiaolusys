...
from shopapp.search.resources  import SearchResource,RankResource
from shopapp.search.views import ShopsRankView,KeywordsMapItemsRankView,ItemsMapKeywordsRankView,KeywordsMapItemsRankPivotView,ItemsMapKeywordsRankPivotView,ShopMapKeywordsTopTradeView,ShopMapKeywordsTradePivotView
from shopback.orders.views import UserHourlyOrderView
from shopapp.search.renderers import JSONRenderer,ChartJSONRenderer,SearchRankHTMLRenderer,ChartTemplateRenderer,RankChartHtmlRenderer\
