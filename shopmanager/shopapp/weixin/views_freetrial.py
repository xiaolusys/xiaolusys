# coding=utf-8
import datetime
from .views import get_user_openid, valid_openid
from django.views.generic import View
from django.shortcuts import redirect, render_to_response
from django.template import RequestContext
from .models import (WeiXinUser, ReferalRelationship, ReferalSummary, ReferalBonusRecord, WXOrder,
                     Refund, WXProduct, WXProductSku, FreeSample, SampleSku, SampleOrder, VipCode, Coupon,
                     CouponClick, Survey, SampleChoose, WeixinUserScore, WeixinScoreItem, WeixinClickScore,
                     WeixinClickScoreRecord, WeixinScoreBuy)
from flashsale.activities.models import Participation, Activities, ParticipateDetail
...
class FreeSampleView(View):
    ...
    def get(self, request):
        ...
        response = render_to_response(self.start_page, {"wx_user": wx_user, "share_customer": share_customer},
                                      context_instance=RequestContext(request))
        response.set_cookie("openid", user_openid)
        return response

    def record_user_participate(self, wx_user, participant_phone):
        ...
        participation.activation_code = wx_user.id
        participation.save()
    ...
    def post(self, request):
        ...
        # 记录参与活动的用户信息
        participation = self.record_user_participate(wx_user, participant_phone)
