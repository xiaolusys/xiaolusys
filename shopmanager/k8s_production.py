...
CELERY_BROKER_URL = 'redis://:%s@redis.default.svc.cluster.local:6379/9' % REDIS_AUTH
CELERY_RESULT_BACKEND = 'redis://:%s@redis.default.svc.cluster.local:6379/8' % REDIS_AUTH
