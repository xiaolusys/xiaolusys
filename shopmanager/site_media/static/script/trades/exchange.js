...
var addSearchTradeRow  = function(tableID,trade){
	...
	var addbtn_cell = goog.dom.createElement('td');
	addbtn_cell.innerHTML = '<button class="trade-buyer-info btn-mini" outer_id="'+prod[0]+'" idx="'+index.toString()+'">复制用户</button>'\
							+'<button class="trade-return-order btn-mini" outer_id="'+prod[0]+'" idx="'+index.toString()+'">加退货单</button>'\
							+'<button class="trade-change-order btn-mini" outer_id="'+prod[0]+'" idx="'+index.toString()+'">加换货单</button>';
...
exchange.Manager.prototype.init = function () {
