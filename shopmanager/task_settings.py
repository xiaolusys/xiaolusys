...
QRCODE_ROUTES = {
    ...
    'flashsale.jimay.tasks.task_weixin_asynchronous_send_payqrcode': {
        'queue': 'qrcode',
        'routing_key': 'qrcode.task_weixin_asynchronous_send_payqrcode',
    },
    'flashsale.jimay.tasks.task_generate_jimay_award_certificate': {
        'queue': 'qrcode',
        'routing_key': 'qrcode.task_generate_jimay_award_certificate',
    },
    'flashsale.jimay.tasks.task_weixin_asynchronous_send_awardcomplete': {
        'queue': 'qrcode',
        'routing_key': 'qrcode.task_weixin_asynchronous_send_awardcomplete',
    },
}
