...
class DailyStatsView(View):
    ...
    def get(request, prev_day):
        try:
            ...
            function_of_task.get_daily_order_stats.delay(prev_day)
            function_of_task.get_daily_ding_huo_stats.delay(prev_day)
            function_of_task.get_daily_goods_arrival_stats.delay(prev_day)
            function_of_task.get_daily_out_order_stats.delay(prev_day)
        except:
