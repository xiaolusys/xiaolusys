...
from flashsale.pay.models import SaleTrade,LogisticsCompany
...
class ProductSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ('url', 'id', 'name', 'outer_id', 'category', 'pic_path','remain_num', 
...
class SaleTradeSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = SaleTrade
        fields = ('url', 'id', 'tid', 'buyer_nick', 'buyer_id', 'channel', 'payment', 'post_fee', 'total_fee',
