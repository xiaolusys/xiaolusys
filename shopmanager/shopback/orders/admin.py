...
class OrderAdmin(admin.ModelAdmin):
    list_display = ('oid','seller_nick','buyer_nick','trade','price','sku_id','num','outer_sku_id','sku_properties_name',
                    'payment','discount_fee','adjust_fee','refund_id','is_oversold','refund_status','outer_id','cid','status')
    ...
    search_fields = ['oid','buyer_nick','sku_properties_name']
