...
from shopback.purchases.models import Purchase,Supplier,Deposite,PurchaseType,PURCHASE_STATUS,PURCHASE_ARRIVAL_STATUS,PURCHASE_STORAGE_STATUS ,PAYMENT_STATUS
...
class SupplierSerializer(serializers.ModelSerializer):
    class Meta:
        model = Supplier
        fields =  ('supply_type','supplier_name','contact' ,'phone' ,'mobile'  ,'fax',  'zip_code' , 'email' ,  'address' , 'account_bank' ,'account_no' ,'main_page' ,'in_use'  , 'extra_info') 
...
class PurchaseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Purchase
        fields =  ('origin_no','attach_files','id', 'unfinish_purchase_items','status','forecast_date','post_date' ,'service_date','creator','created','modified','purchase_num','storage_num','total_fee',
...
class PurchaseStorageSerialize(serializers.ModelSerializer):
    ...
    class Meta:
       ...
       fields = ('origin_no','supplier','forecast_date','deposite','post_date','created','modified','storage_num','status','total_fee',
                 'prepay','payment','logistic_company','out_sid','is_addon','extra_name','extra_info','is_pod','attach_files')
...
class PurchasePaymentSerialize(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('origin_nos','pay_type',' pay_time','payment','supplier','created','modified','status','applier','cashier','pay_no','pay_bank')
