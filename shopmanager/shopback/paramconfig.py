...
#扫描验货称重状态
WAIT_SCAN_CHECK_WEIGHT = (WAIT_CHECK_BARCODE_STATUS,WAIT_SCAN_WEIGHT_STATUS)
#淘宝等待卖家发货对应系统内部状态
...
CANCEL_YUNDASID_STATUS = (WAIT_AUDIT_STATUS,INVALID_STATUS,REGULAR_REMAIN_STATUS,ON_THE_FLY_STATUS)
