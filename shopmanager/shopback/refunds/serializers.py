...
class RefundProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = RefundProduct
        fields = ('buyer_nick','buyer_mobile','buyer_phone','trade_id','out_sid','company','oid','outer_id','outer_sku_id','num','title','property','can_reuse','is_finish','created','modified','memo')
