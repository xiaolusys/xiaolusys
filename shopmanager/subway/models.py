...
class Hotkey(models.Model):
    ...
    def tmall_click_ratio(self):
        return self.num_tmall_click*1.0 / self.num_click

    @property
    def cmall_click_ratio(self):
        return self.num_cmall_click*1.0 / self.num_click

    @property
    def click_ratio(self):
        return self.num_click*1.0 / self.num_search

    @property
    def trade_search_ratio(self):
        return self.num_trade*1.0 / self.num_search

    @property
    def trade_click_ratio(self):
        return self.num_trade*1.0 / self.num_click
...
class KeyScore(models.Model):
    ...
    prod_id = models.CharField(max_length=64,db_index=True)
