# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2017-03-08 12:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app_id', models.BigIntegerField(db_index=True, default=0, null=True, verbose_name='APP ID')),
                ('app_secret', models.CharField(blank=True, max_length=11, unique=True, verbose_name='APP SECRET')),
                ('sign_method', models.CharField(blank=True, default='hash', max_length=16, verbose_name='\u7b7e\u540d\u65b9\u6cd5')),
