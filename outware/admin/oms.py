...
class OutwareOrderAdmin(admin.ModelAdmin):
    list_display = ('outware_account', 'union_order_code', 'order_type', 'store_code', 'status')
...
class OutwareOrderSkuAdmin(admin.ModelAdmin):
    list_display = ('outware_account', 'origin_skuorder_no', 'union_order_code', 'sku_code', 'sku_qty')
...
class OutwarePackageAdmin(admin.ModelAdmin):
    list_display = ('outware_account', 'package_order_code', 'package_type',
                    'store_code', 'logistics_no', 'carrier_code')
...
class OutwarePackageSkuAdmin(admin.ModelAdmin):
    list_display = ('package', 'origin_skuorder_no', 'sku_code', 'batch_no', 'sku_qty')
