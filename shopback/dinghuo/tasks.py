...
from shopback.dinghuo.models import OrderDetail, OrderList,  SupplyChainDataStats, \
...
def task_update_order_group_key(order_ids):
    ...
    order_id_set = set()
    from shopback.forecast import services
...
from shopback.dinghuo.models import DailyStatsPreview, DailySupplyChainStatsOrder
