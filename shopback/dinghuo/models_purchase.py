...
#     from shopback.dinghuo.tasks import task_purchase_detail_update_purchase_order
#     task_purchase_detail_update_purchase_order.delay(instance)
#


# def update_orderdetail(sender, instance, created, **kwargs):
#     from shopback.dinghuo.tasks import task_purchasedetail_update_orderdetail
...
def update_purchase_detail(sender, instance, created, **kwargs):
    if instance.gen_order:
        return
    from shopback.dinghuo.tasks import task_purchasearrangement_update_purchasedetail
