    ...
    def handle(self, *args, **options):
        ...
        for item in items:
            ...
            if sale_order:
                ...
                params.update({'receiver_mobile': sale_order.sale_trade.receiver_mobile,
            ...
            if package_order and package_order.out_sid:
                params.update(
                    {'out_sid': package_order.out_sid, 'logistics_company_name': package_order.logistics_company.name,
                     'logistics_company_code': package_order.logistics_company.code})
